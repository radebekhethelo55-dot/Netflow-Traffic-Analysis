...
## Overview
NetFlow provides granular visibility into IP network traffic flows as they traverse core network interfaces. This project demonstrates real-time telemetry exporting from a Cisco 1941 Edge Router to a centralized monitoring setup.

## Features
- **Traffic Telemetry:** Captures ingress and egress IP flows across internal and external router interfaces.
...
### Network Topology
![Network Topology Diagram](./packet_tracer.png)
